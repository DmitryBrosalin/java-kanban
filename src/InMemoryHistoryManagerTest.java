...
class InMemoryHistoryManagerTest {
    ...
    void getCorrectLinkedHistory() {
        InMemoryHistoryManager inMemoryHistoryManager = new InMemoryHistoryManager();
        Task task1 = new Task("Test Task 1", "Test Task description 1", 1, State.NEW);
        Task task2 = new Task("Test Task 2", "Test Task description 2", 2, State.NEW);
        Task task3 = new Task("Test Task 3", "Test Task description 3", 3, State.NEW);
